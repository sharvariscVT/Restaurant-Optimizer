...
public class EmailController {
    ...
    ===============================
     */
    private String emailTo = "ajitsarkaar@vt.edu";             // Contains only one email address to send email to
    ...
    ************************************************************************************************
    ...
    public InternetAddress[] getAllAddresses() {
//        String[] addrList = {"ajitsarkaar@vt.edu", "ashishshk@vt.edu", "sandhyamb@vt.edu", "sharvarisc@vt.edu"};
        List<Subscribers> subs = getUserFacade().findAllSubscribers();
        InternetAddress[] outList = new InternetAddress[subs.size()];
        try {
            for(int i = 0; i < subs.size(); i++) {
                Subscribers sub = subs.get(i);
                outList[i] = new InternetAddress(sub.getEmail());
            }
    ...
    public void sendEmail() throws AddressException, MessagingException {
        ...
        try {
            ...
            InternetAddress[] sendToList = getAllAddresses();
            htmlEmailMessage.addRecipients(Message.RecipientType.BCC, sendToList);
             ...
             */
            transport.connect("smtp.gmail.com", "bbwinelab@gmail.com", "Qazplm@1209");
