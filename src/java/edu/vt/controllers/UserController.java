...
public class UserController implements Serializable {
    ...
    public List<User> getAllUsers() {
        ...
        if(allUsers == null){
            allUsers =getUserFacade().findAllUser();
        }
    ...
    ***********************************************************
    ...
    public String updateAccount() {
        ...
        try {
             ...
             */
            editUser.setFirstName(this.loggedInUser.getFirstName());
            editUser.setMiddleName(this.loggedInUser.getMiddleName());
            editUser.setLastName(this.loggedInUser.getLastName());

            editUser.setAddress1(this.loggedInUser.getAddress1());
            editUser.setAddress2(this.loggedInUser.getAddress2());
            editUser.setCity(this.loggedInUser.getCity());
            editUser.setState(this.loggedInUser.getState());
            editUser.setZipcode(this.loggedInUser.getZipcode());
            editUser.setEmail(this.loggedInUser.getEmail());
        ...
        if("Administrator".equals(editUser.getUsername())){
