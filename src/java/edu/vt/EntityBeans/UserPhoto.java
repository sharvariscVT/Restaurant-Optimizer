...
// The @Entity annotation designates this class as a JPA Entity class representing the UserPhoto table in the HealthSurveyDB database.
@Entity
...
public class UserPhoto implements Serializable {
    ...
    of the UserPhoto table in the HealthSurveyDB database.
    ========================================================
     */
    ...
    represent a row in the UserPhoto table in the HealthSurveyDB database.
    =================================================================
     */
    public UserPhoto() {
    }
